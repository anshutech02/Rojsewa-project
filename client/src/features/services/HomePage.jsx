...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Hero Section */}
      <section
        className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8 border-b border-zinc-900 bg-zinc-950 bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto text-center flex flex-col gap-6 items-center">
          ...
          <form
            ...
            className="w-full max-w-3xl glass p-3 rounded-2xl flex flex-col md:flex-row gap-2 mt-4"
          >
      ...
      {/* Categories Section */}
      <section className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-4 py-16 flex flex-col gap-8 bg-cover bg-center bg-no-repeat">
        <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-6">
          {categories.map((cat) => (
            <Card
              key={cat._id}
              onClick={() => selectCategory(cat._id)}
              className={`flex flex-col items-center gap-4 p-4 justify-center text-center cursor-pointer transition-all duration-300 backdrop-blur-md rounded-2xl border ${
                selectedCategory === cat._id
            ...
            >
              <span className="text-3xl drop-shadow-[0_4px_12px_rgba(255,255,255,0.1)]">
